; Note: Put your custom routine/data macros, references to them, and defines in this file from within the Plok_InsertIntegratedPatches and Plok_ApplyPatchesPostAssembly macros below.
; By doing this:
...
macro PLOK_InsertIntegratedPatches()
...
macro PLOK_ApplyPatchesPostAssembly()
