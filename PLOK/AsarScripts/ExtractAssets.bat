...
echo - Samples:  Any
echo - Music: Any
echo - PAL exclusive assets: Plok (PAL)
echo - Japanese exclusive assets: Plok (Japan)
echo - German exclusive assets: Plok (German)
echo.

:Start
echo Place a headerless Plok ROM named %ROMName% in this folder, then type the number representing what version %ROMName% is.
echo 0 = Plok (USA)
echo 1 = Plok (PAL)
echo 2 = Plok (Japan)
echo 3 = Plok (French)
...
echo You need to place a Plok ROM named %ROMName% in this folder before you can extract any assets^^!
goto :Mode
...
if %PointerSet% equ 18 goto :MoveGGFX
