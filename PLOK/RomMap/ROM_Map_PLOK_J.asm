...
!Define_PLOK_Global_DisableCopyDetection = !FALSE
	...
	%SetROMToAssembleForHack(PLOK_J, !ROMID)
endmacro
...
macro PLOK_GlobalAssemblySettings()
	...
	!Define_Global_InsertRATSTags = !FALSE
	...
	!Define_Global_LicenseeName = "Activision"
	!Define_Global_DeveloperName = "Software Creations"
	!Define_Global_ReleaseDate = "December 10, 1993"
	!Define_Global_BaseROMMD5Hash = "82f57aa2348fed1eab3377db42b2f3bb"

	!Define_Global_MakerCode = "52"
...
Main:
	...
	%FREE_BYTES(NULLROM, 1951, $00)
	%PLOK_InsertUnsortedData(incbin, GFX_BigJapaneseCharacterFont)
	...
	%PLOK_InsertUnsortedData(incbin, GFX_ActivisionScreen)
	%PLOK_InsertUnsortedData(incbin, Palette_ActivisionScreen)
	...
	%PLOK_InsertUnsortedData(incbin, Tilemap_ActivisionScreen)
	...
	%InsertGarbageData(NULLROM, incbin, UNK_9FD4BF_PLOK_J.bin)
check bankcross on
	%FREE_BYTES(NULLROM, 1, $2A)
%BANK_END(!BANK_1F)
endmacro
