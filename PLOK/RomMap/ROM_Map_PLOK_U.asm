...
!Define_PLOK_Global_DisableCopyDetection = !FALSE
	...
	%SetROMToAssembleForHack(PLOK_U, !ROMID)
endmacro
...
macro PLOK_GlobalAssemblySettings()
	...
	!Define_Global_LicenseeName = "Tradewest Inc."
	!Define_Global_DeveloperName = "Software Creations"
	!Define_Global_ReleaseDate = "September 1993"
	!Define_Global_BaseROMMD5Hash = "478a2723ff6db38428d9b26cf0d504bf"
	...
	!Define_Global_LicenseeID = $5D
	!Define_Global_VersionNumber = $00
	!Define_Global_ChecksumCompliment = !Define_Global_Checksum^$FFFF
	!Define_Global_Checksum = $1C42
	!UnusedNativeModeVector1 = $C208
	!UnusedNativeModeVector2 = $A930
	!NativeModeCOPVector = $0800
...
Main:
	...
	%InsertGarbageData(NULLROM, incbin, UNK_9F8CD9_PLOK_U.bin)
	%FREE_BYTES(NULLROM, 3003, $FF)
	%FREE_BYTES(NULLROM, 1, $F0)
check bankcross on
	%FREE_BYTES(NULLROM, 9729, $FF)
%BANK_END(!BANK_1F)
endmacro
